...
Un petit cryptologue en herbe à voulu réimplémenter un algorithme de chiffrement connu. Cependant, il a oublié une étape cruciale.
...
Ce challenge est une implémentation des fonctions de chiffrement de l'AES.</br>
Cependant, il faut remarqué que chaque round de l'AES n'utilise pas la clef</br>
...
La solution consiste donc à inverser chaque fonction du challenge et à déchiffrer le message.</br>
